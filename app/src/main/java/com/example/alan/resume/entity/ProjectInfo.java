...
public class ProjectInfo {
    ...
    @Generated(hash = 208159234)
    public ProjectInfo(long mId, String mStartTime, String mEndTime, String mTitle,
                       String mContext) {
        this.mId = mId;
    ...
    public static class Builder {
        ...
        public ProjectInfo build() {
            return new ProjectInfo(mId, mStartTime, mEndTime, mTitle, mContext);
        }
